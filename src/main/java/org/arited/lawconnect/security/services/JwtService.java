...
private String buildAccessToken(Long userId, String email, String role, String fullName) {
...
return buildAccessToken(user.getUserId(), user.getEmail(), user.getRole().name(), user.getFullName());
}

public String generateAccessToken(UserPrincipal principal) {
return buildAccessToken(principal.getId(), principal.getEmail(), principal.getRole().name(), principal.getFullName());
}
